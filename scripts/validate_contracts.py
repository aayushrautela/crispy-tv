...
SUITE_TO_SCHEMA = {
    ...
    "onboarding_state_machine": "onboarding_state_machine.schema.json",
    "profile_settings_sync": "profile_settings_sync.schema.json",
    "signup_profile": "signup_profile.schema.json",

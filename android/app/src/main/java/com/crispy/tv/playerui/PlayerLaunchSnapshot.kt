        ...
        fun fromJsonString(value: String?): PlayerLaunchSnapshot? {
            ...
            return runCatching {
                ...
                PlayerLaunchSnapshot(
                    ...
                    tmdbId = json.optPositiveInt("tmdb_id") ?: json.optLegacyTmdbId("provider", "provider_id"),
                    showTmdbId = json.optPositiveInt("show_tmdb_id") ?: json.optLegacyTmdbId("parent_provider", "parent_provider_id"),
...
private fun JSONObject.optLegacyTmdbId(providerKey: String, providerIdKey: String): Int? {
    val provider = optString(providerKey).trim()
    if (!provider.equals("tmdb", ignoreCase = true)) return null
    return optPositiveInt(providerIdKey)
}
